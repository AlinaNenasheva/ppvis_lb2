...
public class View {
	public Button load, save, search, delete, add, firstPage, nextPage, previousPage, lastPage, ok;
	public Table table;
	public Shell shell;
	public Display display;
	public Label pagesCounter, allElements, currentNumberElements;
	public Text textChangeNumber;

	public MenuItem item1, item2, item3, item4, item5, item;
